locals {
  ...
  cluster_security_group_id = local.create_cluster_sg ? (length(aws_security_group.cluster) > 0 ? aws_security_group.cluster.id : null) : var.cluster_security_group_id
